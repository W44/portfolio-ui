...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  ...
  const scrollToSection = (id) => {
    ...
    if (section) {
      ...
      toggleSidebar(); // Close sidebar after clicking a tab
    }
  };
  ...
  return (
    <>
      ...
      <div
        ref={sidebarRef}
        className={`fixed top-0 left-0 w-64 h-full bg-gray-900 text-white transform ${isOpen ? "translate-x-0" : "-translate-x-full"
